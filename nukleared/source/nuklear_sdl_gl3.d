...
extern(C)
void nk_sdl_clipboard_paste(nk_handle usr, nk_text_edit* edit) nothrow @nogc
{
...
extern(C)
void nk_sdl_clipboard_copy(nk_handle usr, const(char)* text, int len) nothrow @nogc
{
...
nk_context* nk_sdl_init(SDL_Window *win)
{
    sdl.win = win;
